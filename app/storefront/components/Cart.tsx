...
import { cartGet } from '../constant/url';

const fetcher = (url: string) => fetch(url).then<Cart>((res) => res.json());
...
export default function CartModal({
  ...
  const { data, error } = useSWR(`${cartGet}/${cartToken}`, fetcher);
                                    ...
                                    <div className="ml-4 flex flex-1 flex-col">
                                      <div>
                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                          ...
                                          >
                                            <a> {variant.productName} </a>
                                            {/* Use product-name + variant name? */}
                                          </Link>
                                          <p className="ml-4">
                                            {variant.price}
                                          </p>
